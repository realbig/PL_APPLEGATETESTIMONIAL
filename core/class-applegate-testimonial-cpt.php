...
class APPLEGATE_Testimonial_CPT {

	private $post_type = 'testimonial';
	private $label_singular = 'Testimonial';
	private $label_plural = 'Testimonials';
	private $icon = 'testimonial';
	...
	private function add_actions() {
		...
		add_action( 'current_screen', array( $this, '_page_functions' ) );
	}

	function _page_functions( $screen ) {

		if ( $screen->id != 'testimonial' ) {
			return;
		}
